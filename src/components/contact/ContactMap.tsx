...
import { mapConfig, contactInfoData, siteConfig } from '@/data/siteData';
        ...
        <section className="relative w-full h-[450px] bg-[#050505] overflow-hidden border-t border-white/5">
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h4 className="text-[10px] tracking-[.3em] uppercase text-muted font-black">{siteConfig.brandName} HQ</h4>
